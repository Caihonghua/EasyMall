...
<html>
	<head>
		...
		<link href="${app}/EasyMallPage/cart/css/cart.css" rel="stylesheet" type="text/css">
		<!-- 引入jQuery函数库 -->
		<script type="text/javascript" src="${app}/EasyMallPage/js/jquery-1.4.2.js"></script>		
	</head>
	...
	<%@ include file="/EasyMallPage/head/_head.jsp" %>
		<div id="wrap">
			...
			<ul class="prods">
				...
				<li class="li_prod">
					<img src="${pageContext.request.contextPath}/servlet/ProductImgServlet?imgurl=${entry.key.imgurl}" width="90" height="90" class="prodimg" />
			...
			<div id="total">
				...
				<div id="total_2">	
					<a id="goto_order" href="${app}/EasyMallPage/orderadd/order_add.jsp">去结算</a>
				</div>
			</div>
		</div>
