...
<html>
<head>
	<link href="${pageContext.request.contextPath}/EasyMallPage/product/css/prodInfo.css" rel="stylesheet" type="text/css">
</head>
<body>
	<div id="warp">
		<div id="left">
			...
			<div id="left_bottom">
				...
				<img id="mid_img" src="${pageContext.request.contextPath}/servlet/ProductImgServlet?imgurl=${prod.imgurl}" width="60px" height="60px" border=0/>
				<img id="rt_img" src="img/prodInfo/rt.jpg"/>
			</div>
		</div>
	<form action="${app}/servlet/CartAddServlet"  method="post">
		<div id="right">
			<div id="right_top">
